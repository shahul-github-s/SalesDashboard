                ...
                <Card.Body>
                  <Row>
                    ...
                    <Col className="text-end">
                      <h2 className="mb-0">1049</h2>
                      <span className="text-c-green">
                        8.2%
                        <i className="feather icon-trending-down ms-1" />
                      </span>
                    </Col>
                  </Row>
                  <Chart {...customerChart} />
              ...
              <Card className="bg-primary text-white">
                <Card.Body>
                  <Row>
                    ...
                    <Col className="text-end">
                      <h2 className="mb-0 text-white">1500</h2>
